...
void MemoryTest_Allocate(struct MemoryDriver* self) 
{
	...
	struct MemoryBlockHeader *ptr1header = MemoryDriver_GetHeaderFromValuePointer(self,ptr1);
	...
	struct MemoryBlockHeader *ptr2header = MemoryDriver_GetHeaderFromValuePointer(self,ptr2);
	...
	struct MemoryBlockHeader *ptr3header = MemoryDriver_GetHeaderFromValuePointer(self,ptr3);
	if (!ptr3header->InUse)
	{
...
void MemoryTest_ReallocateCaseA(struct MemoryDriver* self) 
{
	...
	struct MemoryBlockHeader* ptr1header = MemoryDriver_GetHeaderFromValuePointer(self,ptr1);
	printf("MemoryTest: Reallocation A ptr_1 is set after allocation 0x%x sz=%d\n",(uint32_t)ptr1, ptr1header->Size);
...
void MemoryTest_ReallocateCaseB(struct MemoryDriver* self) 
{
	...
	struct MemoryBlockHeader* header1 = MemoryDriver_GetHeaderFromValuePointer(self,ptr1);	
	struct MemoryBlockHeader* header2 = MemoryDriver_GetHeaderFromValuePointer(self,ptr2);	
	struct MemoryBlockHeader* header3 = MemoryDriver_GetHeaderFromValuePointer(self,ptr3);	
	...
	struct MemoryBlockHeader* reallocated_ptr_2_header = MemoryDriver_GetHeaderFromValuePointer(self,reallocated_ptr_2);
