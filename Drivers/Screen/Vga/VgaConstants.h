...
/*
    Courtesy of https://files.osdev.org/mirrors/geezer/osd/graphics/modes.c
...
#define	VGA_ATTRIB_CTRL_INDEX 0x3C0
#define	VGA_ATTRIB_CTRL_WRITE 0x3C0
#define	VGA_ATTRIB_CTRL_READ  0x3C1
...
#define VGA_GFX_CTRLR_INDEX   0x3CE
#define VGA_GFX_CTRLR_DATA 	  0x3CF
...
#define	VGA_NUM_GFX_CTRLR_REGS    9
#define	VGA_NUM_ATTRIB_CTRL_REGS  21
#define	VGA_NUM_REGS (1 + VGA_NUM_SEQ_REGS + VGA_NUM_CRTC_REGS + VGA_NUM_GFX_CTRLR_REGS + VGA_NUM_ATTRIB_CTRL_REGS)

#define VGA_QEMU_LINEAR_FRAMEBUFFER 0xFD000000
