...
typedef struct FatBiosParameterBlock FatBiosParameterBlock;
...
typedef struct FatExtendedBootRecord16 FatExtendedBootRecord16;
...
typedef struct FatExtendedBootRecord32 FatExtendedBootRecord32;

void FatBPB_Debug(FatBiosParameterBlock* self);
void FatBPB_DebugEBR16(FatExtendedBootRecord16* ebr16);
void FatBPB_DebugEBR32(FatExtendedBootRecord32* ebr32);

uint32_t FatBPB_GetTotalSectors(FatBiosParameterBlock* self);
uint32_t FatBPB_GetFatSizeInSectors(FatBiosParameterBlock* self);
uint32_t FatBPB_GetRootDirectorySizeInSectors(FatBiosParameterBlock* self);
uint32_t FatBPB_GetFirstDataSector(FatBiosParameterBlock* self);
uint32_t FatBPB_GetFirstFATSector(FatBiosParameterBlock* self);
uint32_t FatBPB_GetTotalDataSectors(FatBiosParameterBlock* self);
uint32_t FatBPB_GetTotalClusters(FatBiosParameterBlock* self);
uint32_t FatBPB_GetFirstRootDirectorySector(FatBiosParameterBlock* self);
enum FatType FatBPB_GetFATType(FatBiosParameterBlock* self);